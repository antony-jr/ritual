...
fn main() {
   let matches = App::new(
                    ...
                    .about(&format!("{}", "Make Spirits for the Twenty-First Century Window Sitter.".cyan().bold())[..])
                    .subcommand(SubCommand::with_name("make")
                        .arg(Arg::with_name("source directory")
                                .required(true)
                                .long_help("The location to where the spirit data is placed according to spec.")
                                .index(1))
                        .version(
                            &format!("{} (commit {} {}).",
                                  env!("RITUAL_VERSION").underline(),
                                  ...
                                  env!("RITUAL_BUILD_NO"))[..])
                        .author("D. Antony J.R <antonyjr@protonmail.com>")
                        .about(&format!("{}", "Make Spirit from the given source directory.".magenta().bold())[..]))
